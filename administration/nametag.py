...
def make_image(first_name, last_name, qr_hash):
    ...
    draw.text((340, 140), first_name, (0,0,0), font=nameFont)
    draw.text((340, 210), last_name, (0,0,0), font=nameFont)
    ...
    file_path = '/Nametags/' + first_name + " " + last_name + "-" + str(qr_hash) + '.png'
