...
urlpatterns = [
    ...
    path('puzzles', users.views.view_puzzles),
    path('puzzles/change_name', users.views.change_puzzle_team_name),
    ...
    path('puzzles/view/<str:pid>', users.views.solve_puzzle),
    ...
    path('order/tshirt', applications.views.order_tshirt),
    path('download/order/tshirt', administration.views.tshirt_order_export),
