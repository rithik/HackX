...
APPLICATION_SUBMISSION_DEADLINE = TZ.localize(datetime.datetime(2023, 2, 25, 23, 59, 59, 0))
APPLICATION_SUBMISSION_DEADLINE_FMT = APPLICATION_SUBMISSION_DEADLINE.strftime("%B %d, %Y %I:%M:%S %Z")

APPLICATION_CONFIRMATION_DEADLINE = TZ.localize(datetime.datetime(2023, 3, 4, 23, 59, 59, 0))
